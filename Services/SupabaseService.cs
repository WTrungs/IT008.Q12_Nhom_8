...
namespace TetrisApp.Services
{
    public static class SupabaseService
    {
        ...
        // [MỚI] Hàm đăng xuất: Xóa thông tin người dùng hiện tại
        public static void Logout()
        {
            CurrentUser = null;
            // Nếu muốn kỹ hơn, có thể gọi _client.Auth.SignOut(); 
            // nhưng với cách lưu bảng Players tự chế này thì gán null là đủ.
        }
